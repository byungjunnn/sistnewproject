...
public class Combo_07 extends JFrame implements ActionListener, ItemListener{
	...
	int idx=-1; //멤버변수는 0으로 자동초기화 되는데 0번 삭제를 막기 위해서
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(ob==btnAdd) {
			...
			if(idx==-1) {
				...
				JOptionPane.showMessageDialog(this, "해당 항목을 삭제했습니다");
			}
		}
	}
	@Override
	public void itemStateChanged(ItemEvent e) {
		...
		lblResult.setText(idx+"번 인덱스의 "+item+" 선택됨");//숫자에 문자 더하면 문자
	}
