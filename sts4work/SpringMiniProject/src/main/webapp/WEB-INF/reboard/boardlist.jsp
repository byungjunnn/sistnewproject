...
<div class="searcharea" style="width: 100%; text-align: center;">
	...
	<div class="listarea" style="margin: 10px;">
		<h5 class="alert alert-secondary">총 ${totalCount }개의 게시글이 있습니다</h5>
		<br>
...
<!-- 페이징 -->
<div style="margin: 100px 50px; width: 1000px; text-align: center;">
  <ul class="pagination justify-content-center">
     <!--  이전-->
     <c:if test="${start>1 }">
        <li class="page-item ">
	   <a class="page-link" href="list?currentPage=${start-1 }" style="color: black;">이전</a>
	  </li>
     </c:if>
