...
<div style="margin: 100px 100px; width: 800px;">
	...
	onclick="location.href='addform'" style="margin-left: 700px;">글쓰기</button><br><br>
		...
		<c:if test="${totalCount>0 }">
			<c:forEach var="dto" items="${list }" varStatus="i">
				<tr>
					...
					<td><a href="content?num=${dto.num }&currentPage=${currentPage}" style="color: black; text-decoration: none">${dto.subject }
						<c:if test="${dto.photo!='no'}"><i class="bi bi-image"></i></c:if></a>
					</td>
